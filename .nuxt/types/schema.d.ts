...
declare module '@nuxt/schema' {
  interface ModuleDependencies {
    ["nuxt-quasar-ui"]?: ModuleDependencyMeta<typeof import("nuxt-quasar-ui").default extends NuxtModule<infer O> ? O : Record<string, unknown>>
  ...
  interface NuxtConfig {
    ...
    modules?: (undefined | null | false | NuxtModule<any> | string | [NuxtModule | string, Record<string, any>] | ["nuxt-quasar-ui", Exclude<NuxtConfig["quasar"], boolean>] | ["@nuxt/devtools", Exclude<NuxtConfig["devtools"], boolean>] | ["@nuxt/telemetry", Exclude<NuxtConfig["telemetry"], boolean>])[],
  }
}
declare module 'nuxt/schema' {
  interface ModuleDependencies {
